...
public class ListComponentsSource implements Serializable {
    private final ListComponentsMapperConfiguration configuration;
    private final Tacokit_componentService service;
    private final JsonBuilderFactory jsonBuilderFactory;

    public ListComponentsSource(@Option("configuration") final ListComponentsMapperConfiguration configuration,
