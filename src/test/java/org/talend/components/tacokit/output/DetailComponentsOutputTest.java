package org.talend.components.tacokit.output;
...
public class DetailComponentsOutputTest {
    ...
    public void map() throws IOException {
        ...
        final DetailComponentsOutputConfiguration configuration =  new DetailComponentsOutputConfiguration();

        // We create the component processor instance using the configuration filled above
        final Processor processor = COMPONENT_FACTORY.createProcessor(DetailComponentsOutput.class, configuration);
        ...
        final JoinInputFactory joinInputFactory =  new JoinInputFactory()
                                                            .withInput("__default__", asList(/* TODO - list of your input data for this branch. Instances of DetailComponentsDefaultInput.class */));
